...
const HeroText = () => {
  return (
    <div className="bg-gradient-to-br from-[#E6F1F0] via-[#F3F7F5] to-[#E6F1F0] rounded-bl-xl shadow-lg flex flex-col gap-8 h-full justify-center px-12 max-lg:py-24 max-md:px-8">
