...
const IntroScriptCard = ({ Icon, subtitle, title }: ServiceCardPropsType) => {
  return (
    ...
    >
      <span className="absolute inset-0 rounded-3xl pointer-events-none bg-linear-to-br from-[#E6F1F0] via-[#F3F7F5] to-[#E6F1F0] opacity-0 group-hover:opacity-100 transition-all duration-3000 ease-in-out group-hover:scale-105 blur-[6px] z-0"></span>
